            ...
            <div className="row">
                    ...
                    <div className="d-flex align-items-center mb-4">
                        ...
                        <div className="pl-3">
                            ...
                            <div className="d-flex">
                                <span className="mr-2 text-muted"><i className="fa fa-user"></i> Admin</span>
                                <span className="mr-2 text-muted"><i className="fa fa-folder"></i> Web Design</span>
                                <span className="mr-2 text-muted"><i className="fa fa-comments"></i> 15 Comments</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-12">
                    ...
                    <form>
                        ...
                        <div className="form-group">
                            <input type="submit" value="Leave Comment" className="btn btn-outline-primary px-3"/>
                        </div>
                    </form>
                </div>
            </div>
